            ...
            case 'antilink': {
             ...
             case 'mute': {
                ...
                reply(`${GojoMdNx.user.name} Has Been Unmuted In This Group!`)
                 ...
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'SADUWA-BOT MUTE' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'SADUWA-BOT UNMUTE' }, type: 1 }
                    ]
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      let txt = `❦SADUWA-BOT-SATORU HERE🎉 ❦\n\n${text}`
...
break
        ...
        let buttons = [
                ...
                let buttonMessage = {
                    image: { url: images },
                    caption: `*------- SADUWA-BOT IMAGE SEARCH -------*
🌀 *Query* : ${text}
🔗 *Media Url* : ${images}`,
                    footer: GojoMdNx.user.name,
                    buttons: buttons,
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hi ${pushname}`,
                    description: `           🌀  Please Choose The Menu 🌀\nSADUWA-BOT MD IS AN MODIFIED VERSION OF THE GOJOSENSEI BOT .THANK FOR USING SADUWA-BOT MD.THIS IS MULTIFUNCTIONAL WHATSAPP BOT SO DONT USE BOT FOR BAD THINGS\n\n`,
                    buttonText: "Menu",
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/a75990771bf6cb49f2a0f.jpg' }, caption: `*Hi Bro ${m.pushName}*\nDonation section is currently down🥲 , I know you are happy but me 🥲💔\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/Sandun-Mihiranga2\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
